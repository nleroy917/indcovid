...
const VaccinePage = () => {
    ...
    return (
        ...
        <List>
          <ListItem><b>Are you age 70 or older?</b></ListItem>
          <ListItem>
        ...
        Hoosiers age 70 and older can schedule a vaccination at the link in the red bar above or by calling 2-1-1 if they do not have access to a computer or need assistance registering. Eligible professionals should receive an invitation and registration link from their employer, professional association, or the State of Indiana (Indiana Department of Health, Professional Licensing Agency, Family & Social Services Administration, Department of Homeland Security, or another state agency). If you are a licensed healthcare provider, make sure your email is updated with the Indiana Professional Licensing Agency and continue to check your email and SPAM. If you are eligible and haven’t received an invitation, please ask your employer.
          ...
          <SectionWrapper>
              ...
              <SectionSubTitle>
                  How was the vaccine evaluated for safety?
              </SectionSubTitle>
              <SectionContent>
              ...
              <br></br>
              <SectionSubTitle>
                  Does this vaccine cause any serious side effects like infertility or autism?
              </SectionSubTitle>
              <SectionContent>
              ...
              <SectionSubTitle>
                  The vaccine was developed very quickly, how do we know what the long term effects are? 
              </SectionSubTitle>
              <SectionContent>
              ...
              <br></br>
              <SectionSubTitle>
                  Has the vaccine been tested among all racial/ethnic groups?
              </SectionSubTitle>
              <SectionContent>
              ...
              <br></br>
              <SectionSubTitle>
                  Will the COVID vaccine have any effect on the medications I am taking?
              </SectionSubTitle>
              <SectionContent>
              ...
              <br></br>
              <SectionSubTitle>
                  How long after I get the vaccine is it effective?
              </SectionSubTitle>
              <SectionContent>
              ...
              <br></br>
              <SectionSubTitle>
                  I don't have insurance. How will I pay for the vaccine?
              </SectionSubTitle>
              <SectionContent>
